...
out.writerow(['Ref', 'Qnty', 'Value', 'Cmp name', 'Footprint', 'Description', 'Vendor', 'Vendor Part Number', 'Manufacturer', 'Manufacturer Part Number'])
...
for group in grouped:
	...
	fromNetlistText( c.getField("Vendor Part Number") ),
